...
- (void)layoutSubviews {
    ...
    if(hasCustomView) {
        ...
        self.titleLabel.text = [self.titles count]>self.state?[self.titles objectAtIndex:self.state]:@"";
        
        NSString *subtitle = [self.subtitles count]>self.state?[self.subtitles objectAtIndex:self.state]:@"";
...
- (UILabel *)titleLabel {
    if(!_titleLabel) {
        ...
        _titleLabel.text = @"Pulltorefresh...";
...
- (void)setLastUpdatedDate:(NSDate *)newLastUpdatedDate {
    ...
    self.dateLabel.text = [NSString stringWithFormat:@"%@: %@",@"LastUpdated", newLastUpdatedDate?[self.dateFormatter stringFromDate:newLastUpdatedDate]:@"Never"];
}

- (void)setDateFormatter:(NSDateFormatter *)newDateFormatter {
	dateFormatter = newDateFormatter;
    self.dateLabel.text = [NSString stringWithFormat:@"%@: %@",@"LastUpdated", self.lastUpdatedDate?[newDateFormatter stringFromDate:self.lastUpdatedDate]:@"Never"];
}
